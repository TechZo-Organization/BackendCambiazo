...
{
    public async Task<int> CreateProfile(string firstName, string lastName, string email, int phone, string photo)
    {
        var createProfileCommand = new CreateProfileCommand(firstName, lastName, email, phone, photo);
